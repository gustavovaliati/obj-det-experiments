...
class HelloWorldDataset:
    def __init__(self, num_imgs = 50000, min_object_size = 2, max_object_size = 8,
    ...
    def show_generated(self):
        ...
        for i_subplot in range(1, 6):
            ...
            plt.imshow(self.imgs[i_img], interpolation='none', origin='lower', extent=[0, self.img_size, 0, self.img_size])
